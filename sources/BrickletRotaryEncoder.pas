...
type
  ...
  TBrickletRotaryEncoderNotifyCount = procedure(aSender: TBrickletRotaryEncoder; const aCount: longint) of object;
  TBrickletRotaryEncoderNotifyCountReached = procedure(aSender: TBrickletRotaryEncoder; const aCount: longint) of object;
  ...
  public
    ...
    ///  last triggering.
    /// </summary>
    procedure SetCountCallbackPeriod(const aPeriod: longword); virtual;
...
function TBrickletRotaryEncoder.GetCount(const aReset: boolean): longint;
var 
...
procedure TBrickletRotaryEncoder.SetCountCallbackPeriod(const aPeriod: longword);
var 
...
procedure TBrickletRotaryEncoder.GetIdentity(out aUID: string; out aConnectedUID: string; out aPosition: char; out aHardwareVersion: TTFVersionNumber; out aFirmwareVersion: TTFVersionNumber; out aDeviceIdentifier: word);
var 
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
...
begin
  ...
  if (Assigned(countReachedCallback)) then begin
    countReachedCallback(self, _count);
  end;
end;
