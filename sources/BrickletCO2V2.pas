...
type
  ...
  TBrickletCO2V2NotifyAllValues = procedure(aSender: TBrickletCO2V2; const aCO2Concentration: word;
                                            const aTemperature: smallint; const aHumidity: word) of object;
  TBrickletCO2V2NotifyCO2Concentration = procedure(aSender: TBrickletCO2V2; const aCO2Concentration: word) of object;
  TBrickletCO2V2NotifyTemperature = procedure(aSender: TBrickletCO2V2; const aTemperature: smallint) of object;
  TBrickletCO2V2NotifyHumidity = procedure(aSender: TBrickletCO2V2; const aHumidity: word) of object;
  ...
  public
    ...
    ///  </note>
    /// </summary>
    procedure GetAllValues(out aCO2Concentration: word; out aTemperature: smallint; out aHumidity: word); virtual;
    ...
    /// </summary>
    procedure SetAirPressure(const aAirPressure: word); virtual;
    ...
    /// </summary>
    procedure SetTemperatureOffset(const aOffset: word); virtual;
    ...
    /// </summary>
    procedure SetCO2ConcentrationCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean;
    ...
    /// </summary>
    procedure GetCO2ConcentrationCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean;
    ...
    ///  If the option is set to 'x' (threshold turned off) the callback is triggered with the fixed period.
    /// </summary>
    procedure SetHumidityCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean; const aOption: char;
    ...
    /// </summary>
    procedure GetHumidityCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean;
                                               out aOption: char; out aMin: word; out aMax: word); virtual;
...
procedure TBrickletCO2V2.GetAllValues(out aCO2Concentration: word; out aTemperature: smallint; out aHumidity: word);
var 
  _request, _response: TDynamicByteArray;
begin
  _request:= IPConnection.CreateRequestPacket(self, BRICKLET_CO2_V2_FUNCTION_GET_ALL_VALUES, 8);
  _response:= SendRequest(_request);
  aCO2Concentration:= LEConvertUInt16From(8, _response);
  aTemperature:= LEConvertInt16From(10, _response);
  aHumidity:= LEConvertUInt16From(12, _response);
end;

procedure TBrickletCO2V2.SetAirPressure(const aAirPressure: word);
var 
  _request: TDynamicByteArray;
begin
  _request:= IPConnection.CreateRequestPacket(self, BRICKLET_CO2_V2_FUNCTION_SET_AIR_PRESSURE, 10);
  LEConvertUInt16To(aAirPressure, 8, _request);
...
procedure TBrickletCO2V2.SetTemperatureOffset(const aOffset: word);
var 
  _request: TDynamicByteArray;
begin
  _request:= IPConnection.CreateRequestPacket(self, BRICKLET_CO2_V2_FUNCTION_SET_TEMPERATURE_OFFSET, 10);
  LEConvertUInt16To(aOffset, 8, _request);
  SendRequest(_request);
end;
...
procedure TBrickletCO2V2.SetAllValuesCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.GetAllValuesCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.SetCO2ConcentrationCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean; const aOption: char; const aMin: word; const aMax: word);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.GetCO2ConcentrationCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean; out aOption: char; out aMin: word; out aMax: word);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.SetHumidityCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean; const aOption: char; const aMin: word; const aMax: word);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.GetHumidityCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean; out aOption: char; out aMin: word; out aMax: word);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.GetSPITFPErrorCount(out aErrorCountAckChecksum: longword; out aErrorCountMessageChecksum: longword; out aErrorCountFrame: longword; out aErrorCountOverflow: longword);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.SetWriteFirmwarePointer(const aPointer: longword);
var 
  _request: TDynamicByteArray;
begin
...
function TBrickletCO2V2.WriteFirmware(const aData: array of byte): byte;
var 
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
...
procedure TBrickletCO2V2.SetStatusLEDConfig(const aConfig: byte);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletCO2V2.GetIdentity(out aUID: string; out aConnectedUID: string; out aPosition: char; out aHardwareVersion: TTFVersionNumber; out aFirmwareVersion: TTFVersionNumber; out aDeviceIdentifier: word);
var 
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
...
begin
  ...
  _temperature:= LEConvertInt16From(10, aPacket);
  _humidity:= LEConvertUInt16From(12, aPacket);

  if (Assigned(fAllValuesCallback)) then begin
    fAllValuesCallback(self, _co2Concentration, _temperature, _humidity);
  end;
end;
