...
type
  ...
  TBrickletIO4V2NotifyInputValue = procedure(aSender: TBrickletIO4V2; const aChannel: byte; const aChanged: boolean;
                                             const aValue: boolean) of object;
  TBrickletIO4V2NotifyAllInputValue = procedure(aSender: TBrickletIO4V2; const aChanged: TArray0To3OfBoolean;
                                                const aValue: TArray0To3OfBoolean) of object;
  TBrickletIO4V2NotifyMonoflopDone = procedure(aSender: TBrickletIO4V2; const aChannel: byte; const aValue: boolean) of object;
  ...
  public
    ...
    ///  is called.
    /// </summary>
    procedure SetPWMConfiguration(const aChannel: byte; const aFrequency: longword; const aDutyCycle: word); virtual;

    /// <summary>
    ///  Returns the PWM configuration as set by <see cref="BrickletIO4V2.TBrickletIO4V2.SetPWMConfiguration"/>.
    /// </summary>
    procedure GetPWMConfiguration(const aChannel: byte; out aFrequency: longword; out aDutyCycle: word); virtual;
...
procedure TBrickletIO4V2.SetValue(const aValue: array of boolean);
var 
...
begin
  ...
  for _i:= 0 to 3 do if aValue[_i] then _valueBits[Floor(_i / 8)]:= _valueBits[Floor(_i / 8)] or (1 shl (_i mod 8));
...
procedure TBrickletIO4V2.SetSelectedValue(const aChannel: byte; const aValue: boolean);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetConfiguration(const aChannel: byte; const aDirection: char; const aValue: boolean);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetConfiguration(const aChannel: byte; out aDirection: char; out aValue: boolean);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetInputValueCallbackConfiguration(const aChannel: byte; const aPeriod: longword; const aValueHasToChange: boolean);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetInputValueCallbackConfiguration(const aChannel: byte; out aPeriod: longword; out aValueHasToChange: boolean);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetAllInputValueCallbackConfiguration(const aPeriod: longword; const aValueHasToChange: boolean);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetAllInputValueCallbackConfiguration(out aPeriod: longword; out aValueHasToChange: boolean);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetMonoflop(const aChannel: byte; const aValue: boolean; const aTime: longword);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetMonoflop(const aChannel: byte; out aValue: boolean; out aTime: longword; out aTimeRemaining: longword);
var 
  _request, _response: TDynamicByteArray;
begin
...
function TBrickletIO4V2.GetEdgeCount(const aChannel: byte; const aResetCounter: boolean): longword;
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetEdgeCountConfiguration(const aChannel: byte; const aEdgeType: byte; const aDebounce: byte);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetEdgeCountConfiguration(const aChannel: byte; out aEdgeType: byte; out aDebounce: byte);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetPWMConfiguration(const aChannel: byte; const aFrequency: longword; const aDutyCycle: word);
var 
  _request: TDynamicByteArray;
begin
  _request:= IPConnection.CreateRequestPacket(self, BRICKLET_IO4_V2_FUNCTION_SET_PWM_CONFIGURATION, 15);
  LEConvertUInt8To(aChannel, 8, _request);
  LEConvertUInt32To(aFrequency, 9, _request);
  LEConvertUInt16To(aDutyCycle, 13, _request);
  SendRequest(_request);
end;

procedure TBrickletIO4V2.GetPWMConfiguration(const aChannel: byte; out aFrequency: longword; out aDutyCycle: word);
var 
  _request, _response: TDynamicByteArray;
begin
  ...
  LEConvertUInt8To(aChannel, 8, _request);
  _response:= SendRequest(_request);
  aFrequency:= LEConvertUInt32From(8, _response);
  aDutyCycle:= LEConvertUInt16From(12, _response);
end;

procedure TBrickletIO4V2.GetSPITFPErrorCount(out aErrorCountAckChecksum: longword; out aErrorCountMessageChecksum: longword; out aErrorCountFrame: longword; out aErrorCountOverflow: longword);
var 
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.SetWriteFirmwarePointer(const aPointer: longword);
var 
  _request: TDynamicByteArray;
begin
...
function TBrickletIO4V2.WriteFirmware(const aData: array of byte): byte;
var 
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
...
procedure TBrickletIO4V2.SetStatusLEDConfig(const aConfig: byte);
var 
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIO4V2.GetIdentity(out aUID: string; out aConnectedUID: string; out aPosition: char; out aHardwareVersion: TTFVersionNumber; out aFirmwareVersion: TTFVersionNumber; out aDeviceIdentifier: word);
var 
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
