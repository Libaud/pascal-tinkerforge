...
type
  ...
  TBrickletIndustrialDigitalOut4V2NotifyMonoflopDone = procedure(aSender: TBrickletIndustrialDigitalOut4V2; const aChannel: byte; const aValue: boolean) of object;
...
procedure TBrickletIndustrialDigitalOut4V2.SetSelectedValue(const aChannel: byte; const aValue: boolean);
var
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.SetMonoflop(const aChannel: byte; const aValue: boolean; const aTime: longword);
var
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.GetMonoflop(const aChannel: byte; out aValue: boolean; out aTime: longword; out aTimeRemaining: longword);
var
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.SetChannelLEDConfig(const aChannel: byte; const aConfig: byte);
var
  _request: TDynamicByteArray;
begin
...
function TBrickletIndustrialDigitalOut4V2.GetChannelLEDConfig(const aChannel: byte): byte;
var
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.SetPWMConfiguration(const aChannel: byte; const aFrequency: longword; const aDutyCycle: word);
var
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.GetPWMConfiguration(const aChannel: byte; out aFrequency: longword; out aDutyCycle: word);
var
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.GetSPITFPErrorCount(out aErrorCountAckChecksum: longword; out aErrorCountMessageChecksum: longword; out aErrorCountFrame: longword; out aErrorCountOverflow: longword);
var
  _request, _response: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.SetWriteFirmwarePointer(const aPointer: longword);
var
  _request: TDynamicByteArray;
begin
...
function TBrickletIndustrialDigitalOut4V2.WriteFirmware(const aData: array of byte): byte;
var
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.SetStatusLEDConfig(const aConfig: byte);
var
  _request: TDynamicByteArray;
begin
...
procedure TBrickletIndustrialDigitalOut4V2.GetIdentity(out aUID: string; out aConnectedUID: string; out aPosition: char; out aHardwareVersion: TTFVersionNumber; out aFirmwareVersion: TTFVersionNumber; out aDeviceIdentifier: word);
var
  _request, _response: TDynamicByteArray;
  _i: longint;
begin
